...
from .views import index, login, deseos, shop, contact, checkout, productos, details, create_producto, agregar_al_carrito, ver_carrito, quitar_del_carrito,actualizar_carrito
